...
import com.example.pruebamedicamento.model.Ciudad;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Sede getSedeById(long sedeId) {
        ...
        cursor.close();
        return sede;
    }public List<TipoMedicamento> getAllCategorias() {
        List<TipoMedicamento> categorias = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        String query = "SELECT * FROM tipos_medicamento"; // Reemplaza "categorias" con el nombre real de tu tabla
        Cursor cursor = db.rawQuery(query, null);

        if (cursor.moveToFirst()) {
            do {
                @SuppressLint("Range") TipoMedicamento categoria = new TipoMedicamento(
                        cursor.getLong(cursor.getColumnIndex("id")),
    ...
    public List<PrecioMedicamento> getPreciosMedicamentosFiltered(FilterHelper filterHelper) {
        ...
        // Añadir filtro por sede si está especificado
        if (filterHelper.getSelectedSedeId() != null) {
            whereConditions.add("s.id = ?");
            selectionArgs.add(String.valueOf(filterHelper.getSelectedSedeId()));
        }
    ...
    // Método sobrecargado para filtrar por sede específica
    public List<PrecioMedicamento> getPreciosMedicamentosFiltered(FilterHelper filterHelper, long sedeId) {
        filterHelper.setSelectedSedeId(sedeId);
        List<PrecioMedicamento> resultado = getPreciosMedicamentosFiltered(filterHelper);
        filterHelper.setSelectedSedeId(null); // Limpiar el filtro de sede después de usarlo
        return resultado;
    }
    ...
    @SuppressLint("Range")
    public List<PrecioMedicamento> getPreciosMedicamentoPorCategoria(String tipo) {
        List<PrecioMedicamento> precios = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();

        // Query corregido basado en el esquema mostrado
        String query = "SELECT pm.id, pm.medicamento_id, pm.franquicia_id, pm.precio, " +
                "m.marca as nombre_medicamento, " + // Cambiado de m.nombre a m.marca
                "f.nombre as nombre_franquicia " +
                "FROM precio_medicamento pm " +
                "INNER JOIN medicamentos m ON pm.medicamento_id = m.id " +
                "INNER JOIN franquicias f ON pm.franquicia_id = f.id " +
                "INNER JOIN tipos_medicamento tm ON m.tipo_id = tm.id " + // Agregado join con tipos_medicamento
                "WHERE tm.nombre = ?";
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                // Establecer los nombres recuperados del JOIN
                precio.setNombreMedicamento(cursor.getString(cursor.getColumnIndex("nombre_medicamento")));
                precio.setNombreFranquicia(cursor.getString(cursor.getColumnIndex("nombre_franquicia")));
    ...
    //crea las tablas locales en SQLITE
    ...
    //metodo que inserta los datos de ejemplo en SQLITE, estos luego pueden ser subidos a FIREBASE directamente
    private void insertInTables(SQLiteDatabase sqLiteDatabase) {
    ...
    private void insertarDatosPrecioMedicamento(SQLiteDatabase db) {
        ...
        String[] insertQueries = {
                ...
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (1, 1, 1250)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (1, 2, 1280)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (1, 4, 1045)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (2, 1, 850)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (2, 3, 860)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (2, 4, 760)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (3, 1, 2100)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (3, 2, 2150)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (3, 4, 1880)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (4, 2, 3425)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (4, 3, 3400)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (4, 4, 3200)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (5, 1, 945)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (5, 2, 960)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (5, 4, 855)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (6, 1, 500)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (6, 3, 510)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (6, 4, 480)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (7, 1, 300)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (7, 3, 305)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (7, 4, 290)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (8, 1, 1500)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (8, 2, 1525)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (8, 4, 1450)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (9, 2, 1225)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (9, 3, 1190)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (9, 4, 1150)",

                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (10, 1, 950)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (10, 2, 970)",
                "INSERT INTO precio_medicamento (medicamento_id, franquicia_id, precio) VALUES (10, 3, 960)"
        };
